...
| "Grok":https://github.com/jordansissel/grok   | Master branch               |
...
| TCP        | 5544   | The value for @AccessFrom@ | Logstash      | To send log messages via Rsyslog  |
| TCP        | 12201  | The value for @AccessFrom@ | Logstash      | To send log messages via Gelf     |
